...
const Header = () => (
  <header class="fixed top-0 inset-x-0 .z-auto bg-white shadow border-t-4 border-indigo-600">
      ...
      <div class="flex items-center justify-between">
          <div>
              <a class="flex items-center text-gray-800 hover:text-indigo-600" href="#">
                  ...
                  <span class="mx-3 font-medium text-sm md:text-base">Jason Ludden</span>
              </a>
          </div>
